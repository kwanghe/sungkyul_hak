...
public class grade3 extends AppCompatActivity {
        ...
        btnReturn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (subject1.equals("")||jumsu1.equals("")) {}
                    ...
                    task.execute("http://" + IP_ADDRESS + "/work" + "/data_insert.php", id, String.valueOf(grade),"3", subject1, jumsu1);
                ...
                if (subject2.equals("")||jumsu2.equals("")) {}
                    ...
                    InsertData task = new InsertData();
                    task.execute("http://" + IP_ADDRESS + "/work" + "/data_insert.php", id, String.valueOf(grade),"3", subject2, jumsu2);
                ...
                if (subject3.equals("")||jumsu3.equals("")) {}
                    ...
                    InsertData task = new InsertData();
                    task.execute("http://" + IP_ADDRESS + "/work" + "/data_insert.php", id, String.valueOf(grade),"3", subject3, jumsu3);
                ...
                if (subject4.equals("")||jumsu4.equals("")) {}
                    ...
                    InsertData task = new InsertData();
                    task.execute("http://" + IP_ADDRESS + "/work" + "/data_insert.php", id, String.valueOf(grade),"3", subject4, jumsu4);
                ...
                if (subject3.equals("")||jumsu5.equals("")) {}
                    ...
                    InsertData task = new InsertData();
                    task.execute("http://" + IP_ADDRESS + "/work" + "/data_insert.php", id, String.valueOf(grade),"3", subject5, jumsu5);
                ...
                if (subject6.equals("")||jumsu6.equals("")) {}
                    ...
                    InsertData task = new InsertData();
                    task.execute("http://" + IP_ADDRESS + "/work" + "/data_insert.php", id, String.valueOf(grade),"3", subject6, jumsu6);
                ...
                if (subject7.equals("")||jumsu7.equals("")) {}
                    ...
                    InsertData task = new InsertData();
                    task.execute("http://" + IP_ADDRESS + "/work" + "/data_insert.php", id, String.valueOf(grade),"3", subject7, jumsu7);
                ...
                if (subject8.equals("")||jumsu8.equals("")) {}
                    ...
                    InsertData task = new InsertData();
                    task.execute("http://" + IP_ADDRESS + "/work" + "/data_insert.php", id, String.valueOf(grade),"3", subject8, jumsu8);
                    db_1subject8.setText("");
                    db_1jumsu8.setText("");
                }
                Intent intent = new Intent(grade3.this, grade4.class);
    ...
    class InsertData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(grade3.this,
